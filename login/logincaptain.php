...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM pilot_users WHERE username='$username' AND password='$password'";
    $result = mysqli_query($koneksi, $query);

    if (mysqli_num_rows($result) === 1) {
    $data = mysqli_fetch_assoc($result);
    $_SESSION['username'] = $data['username'];
    $_SESSION['pilot_id'] = $data['id']; // pastikan kolom di tabel pilot_users adalah 'id'
  ...
  <div class="container">
    ...
    <div class="login-box">
      ...
      <div class="content">
        ...
        <form method="POST" action="logincaptain.php">
